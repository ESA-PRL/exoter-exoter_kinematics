...
namespace exoter_kinematics
{
    ...
    static const double LEG_LENGTH = 0.120;
    static const double FRONT_PASSIVE_TO_VIRTUAL = 0.150;
    static const double REAR_PASSIVE_TO_VIRTUAL = 0.365;
    static const double REAR_VIRTUAL_TO_STEERING = 0.000;
    static const double VIRTUAL_TO_WALKING = -0.010;
    static const double CENTERLINE_TO_STEERING = 0.365;
    static const double BODY_TO_FRONT = 0.210;
    static const double BODY_TO_REAR = 0.360;
    ...
    enum Joint_Order {PASSIVE_LEFT, PASSIVE_RIGHT, PASSIVE_REAR,
                      ...
                      STEERING_FL, STEERING_FR, STEERING_ML, STEERING_MR, STEERING_RL, STEERING_RR,
